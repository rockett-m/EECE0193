...
public:
    ...
    /* for DWM	*/
    double shiftLatency;					/* Unit: s */
    double shiftDynamicEnergy;						/* Unit: J */

    /* for MLC MRAM */
    double setLatencySoft, resetLatencySoft;
    double setDynamicEnergySoft, resetDynamicEnergySoft;
    double cellSetEnergySoft, cellResetEnergySoft;
